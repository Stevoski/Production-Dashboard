 ...
 * @author Stevoski
 */
public class loaderAllIngredients {
    ResultSet rs;
...
//            product_name, factory, unit, unit_price, groupe, overhead_costs, kgsperpc, stock_in_hand, productoverhead
            while (raes.next()) {
               product= new productProductionReturns(raes.getString("factory"), raes.getString("Ingredient"), raes.getDouble("ingredient_price"),raes.getInt("ingredient_price"));
